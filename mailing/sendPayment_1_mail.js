...
const sendPayment1Mail = async (
  ...
  try {
    ...
    const mailOptions = {
      ...
      to: email,
      subject: payment_1_email(id),
      template: "payment1",
      context: {
        title: payment_1_email(id),
        amount: amount,
    ...
    return responseHandler(res, true, 200, payment_1_confirmation_email);
  } catch (error) {
...
module.exports = { sendPayment1Mail };
